...
@pytest.mark.parametrize("platform", [
    pytest.param("linux", marks=pytest.mark.skipif(sys.platform != "linux", reason="Linux only")),
    pytest.param("darwin", marks=pytest.mark.skipif(sys.platform != "darwin", reason="macOS only")),
    pytest.param("win32", marks=pytest.mark.skipif(sys.platform != "win32", reason="Windows only")),
])
