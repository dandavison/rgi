...
An interactive search tool that combines the power of ripgrep, fzf, bat, and delta to provide a seamless file searching experience.

## Features

- **Interactive search**: Real-time results as you type
- **Syntax highlighting**: Beautiful code previews with bat
- **Diff-friendly output**: Git-style diffs with delta  
- **Mode switching**: Toggle between pattern and command modes with Tab
- **Smart defaults**: Follows symlinks, searches hidden files, excludes .git
